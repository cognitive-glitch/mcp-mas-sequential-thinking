...
class TestToolModelsModule:
    ...
    def test_import_tool_decision(self):
        ...
        decision = create_test_tool_decision(
            tool_name="ExaTools",
    ...
    def test_import_tool_selection_result(self):
        ...
        tool_rec = create_test_tool_recommendation(
            tool_name="TestTool", confidence=0.85, rationale="Testing", priority=1
        )
...
class TestBackwardCompatibility:
    ...
    def test_cross_module_relationships(self):
        ...
        tool_rec = create_test_tool_recommendation(
            tool_name="TestTool", confidence=0.9, rationale="Testing", priority=1
        )
