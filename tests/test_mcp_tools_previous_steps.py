...
def mock_app_context():
    ...
    mock_context.get_performance_metrics = AsyncMock(return_value={
        'total_thoughts': 3,
...
class TestPreviousStepsConversion:
    ...
    async def test_previous_steps_conversion_empty(self, mock_app_context):
        ...
        with patch('tools.mcp_tools.process_thought_with_dual_teams') as mock_process, \
            ...
            thought_data = mock_process.call_args[0][0]  # First argument should be ThoughtData
