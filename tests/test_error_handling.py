...
from error_handling import CircuitBreaker, EnhancedErrorHandler, ErrorSeverity, ErrorContext
...
class TestCircuitBreaker:
    ...
    def test_circuit_breaker_half_open_failure(self):
        ...
        assert cb.is_open is True
        assert cb.can_proceed() is False
        assert cb.last_failure_time > initial_failure_time  # Updated timestamp
...
class TestEnhancedErrorHandler:
    ...
    def test_error_handler_initialization(self, error_handler):
        ...
        assert isinstance(error_handler.circuit_breakers["team_processing"], CircuitBreaker)
        assert isinstance(error_handler.circuit_breakers["model_communication"], CircuitBreaker)
    ...
    def test_handle_validation_error(self, error_handler):
        ...
        assert recovery_msg == "Input validation failed. Please check the format and try again."
    ...
    def test_error_context_creation(self, error_handler):
        ...
        assert error_context.recovery_attempted is True  # Should be set after recovery message
...
class TestErrorSeverityEnum:
    ...
    def test_error_severity_comparison(self):
        ...
        all_severities = [ErrorSeverity.LOW, ErrorSeverity.MEDIUM, ErrorSeverity.HIGH, ErrorSeverity.CRITICAL]
